        ...
        if (json.status) {
            ...
            current_address_checkbox.addEventListener("change", function () {
                ...
                if (current_address_checkbox.checked) {
                    first_name.value = userAddress.user.name;
...
//            // cart-details
            ...
            cartItems.forEach(cart => {
                ...
                st_item_tr_clone.querySelector("#st-product-price").innerHTML = new Intl.NumberFormat("en-US",{minimumFractionDigits: 2}).format(item_sub_total);
...
async function checkout() {
    ...
    if (response.ok) {
        ...
        if (json.status) {
            ...
            alert("Somthing went wrong. Please try again PayHere Process!");
        }
    } else {
