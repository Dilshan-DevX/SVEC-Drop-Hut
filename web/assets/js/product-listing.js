...
//            loadSelect("model", json.modelList,"name");
            loadSelect("cqlty", json.camaraList,"value");
...
async function saveProduct() {
    ...
    const camaraId = document.getElementById("cqlty").value;
    ...
    if (response.ok) {
        ...
        if (json.status) {
            ...
            document.getElementById("cqlty").value = 0;
