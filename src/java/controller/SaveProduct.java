...
public class SaveProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String camaraId = request.getParameter("camaraId");
...
//        System.out.println(qty);
        ...
        } else if (!Util.isInteger(camaraId)) {
            responseObject.addProperty("message", "Invalid storage");
        } else if (Integer.parseInt(camaraId) == 0) {
            ...
            if (brand == null) {
                ...
                if (model == null) {
                    ...
                    if (model.getBrand().getId() != brand.getId()) {
                        ...
                        Camara camara = (Camara) s.get(Camara.class, Integer.valueOf(camaraId));
                        if (camara == null) {
                            responseObject.addProperty("message", "Please select a valid Camara!");
                        } else {
