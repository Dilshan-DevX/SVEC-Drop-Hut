...
public class CheckOut extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name = requJsonObject.get("name").getAsString();
...
//                            address.setMobile(mobile);
    ...
    private void processCheckout(Session s,
        ...
        try {
            ...
            //PayHere process
            String merahantID = "1225048";
            String merchantSecret = "MjEzNTQyNjQ4NTI0MDc3OTgyNzI3MTIzNDg3NjEyOTEzODYzMTc0";
            ...
            payHereJson.addProperty("notify_url", " https://9e1d58ad392c.ngrok-free.app/FoodCity_Web_II/VerifyPayments");
            ...
            payHereJson.addProperty("first_name", user.getName());
            payHereJson.addProperty("last_name", user.getName());
            ...
            responseObject.addProperty("message", "Chckout completed");
